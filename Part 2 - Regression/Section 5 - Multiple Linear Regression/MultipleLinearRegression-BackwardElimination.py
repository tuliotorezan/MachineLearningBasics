...
#backward elemination manually

#we specify all the indexes in order to be able to eliminate them one by one later in the code
X_opt = X[:, [0,1,2,3,4,5]]
...
# Automated Backward elimination taking into account both p-val and Adjusted R squared
...
SL = 0.05
X_opt = X[:, [0, 1, 2, 3, 4, 5]]
X_ModeledR = backwardEliminationR(X_opt, SL)
